...
# programs
bcftools=bcftools
vcftools=/maps/projects/seqafrica/people/rlk420/software/bin/vcftools
beagle3=/maps/projects/seqafrica/people/rlk420/software/bin/beagle.jar
gprobs2beagle=/maps/projects/seqafrica/people/rlk420/software/bin/gprobs2beagle.jar
beagle2vcf=/maps/projects/seqafrica/people/rlk420/software/bin/beagle2vcf.jar
beagle2hap=/maps/projects/seqafrica/people/rlk420/software/bin/beagle_phased_to_hap_sample.py
gtdiscord=/maps/projects/seqafrica/people/rlk420/software/bin/calc_imputed_gt_discord.py
    ...
    for chrom in $chrs; do
        {
            ...
            if [ ! -s $out.gprobs.gz ];then
            java -Xss5m -Xmx20g -Djava.io.tmpdir=$outdir -jar $beagle3 like=$input out=$outpre &> $out.llog
            zcat $out.gprobs.gz |
