...
/home/users/xi/software/bedtools2/bin/bedtools subtract -a water_buffalo.reference.fna.fai.bed -b water_buffalo.reference.fna.masked.repeat.bed > 
water_buffalo.reference.fna.masked.NOrepeat.bed
