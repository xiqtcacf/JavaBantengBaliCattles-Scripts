...
VCFUTILS=config["VCFUTILS"] ## "/home/krishang/software/bcftools/bcftools-1.9/bin/vcfutils.pl"
BCFTOOLS=config["BCFTOOLS"] ## "/home/krishang/software/bcftools/bcftools-1.9/bin/bcftools"
PSMC_DIR=config["PSMC_DIR"] ## "/home/krishang/software/psmc/psmc"
FQ2PSMCFA=os.path.join(PSMC_DIR,"utils/fq2psmcfa")
PSMC=os.path.join(PSMC_DIR,"psmc")

FA=config["REF"] ## "/home/leopard/users/krishang/mapping_cat/refs/Felis_catus.Felis_catus_9.0.dna_sm.toplevel.fa"
...
## plots script from leopards. USE DEFAULT MUT RATE AND GENERATIONS TIME.
## https://github.com/KHanghoj/leopardpaper/blob/master/figures/het_psmc/plotPsmcMoreBigcats.R
