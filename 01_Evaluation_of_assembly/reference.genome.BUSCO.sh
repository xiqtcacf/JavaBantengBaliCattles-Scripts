...
export DIR=/home/wlk579/1.0JavaBanteng_project/0.Reference_Banteng_BosTau9_Waterbuffol_comparison/Banteng_PlusMt
cd $DIR
...
###### evaluate quality of assembly and annotation, using BUSCO-4.5.5
###evaluate assembly quality by version BUSCO 4.5.5
