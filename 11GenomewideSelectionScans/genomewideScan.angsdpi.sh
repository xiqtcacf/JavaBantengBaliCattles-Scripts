...
while read file ; do
 ...
 $thetaStat do_stat WildJavaBanteng.BantengRef.thetas.idx -win 100000 -step 100000  -outnames WildJavaBanteng.BantengRef.thetas.win100k.thetasWindow.gz
...
inputPop=/home/wlk579/1.0JavaBanteng_project/7.GT.Analyses.FstPi/pop
 ...
 $thetaStat do_stat Bali.BantengRef.thetas.idx -win 100000 -step 100000  -outnames Bali.BantengRef.thetas.win100k.thetasWindow.gz
